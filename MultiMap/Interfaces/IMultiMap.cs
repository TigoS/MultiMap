namespace MultiMap.Interfaces
{
    ...
    /// supports enumeration of all key-value pairs and provides methods for bulk operations and querying.</remarks>
        ...
        where TValue : notnull
    {
        ...
        /// </summary>
        /// <remarks>If the collection already contains the specified key,
        /// the method does not modify the collection and returns false.
        /// The behavior regarding null keys or values depends on the specific implementation.</remarks>
        ...
        /// <returns>true if the key was found and its values were removed; otherwise, false.</returns>
        ...
        /// <returns>true if an element with the specified key and value exists in the collection; otherwise, false.</returns>
