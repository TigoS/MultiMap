namespace MultiMap.Interfaces
{
    ...
    /// supporting retrieval and removal of key-value pairs.
    /// </summary>
    /// <remarks>Implementations of this interface allow storing multiple values for a single key and provide
    /// methods to add, retrieve, and remove key-value pairs.
    /// The interface does not specify whether keys or values can be null;
    /// this depends on the specific implementation.
    /// The collection supports enumeration of all key-value pairs.</remarks>
        ...
        where TValue : notnull
    {
        ...
        /// </summary>
        /// <remarks>If the key already exists in the collection, the method does not modify the existing
        /// entry and returns false.
        /// The behavior regarding null keys or values depends on the implementation of the collection.</remarks>
        ...
        /// <returns>true if the key and value were added successfully;
        /// otherwise, false if the key already exists in the collection.</returns>
        ...
        /// Throws a KeyNotFount exception if the key is not found.</returns>
        /// <exception cref="KeyNotFoundException">
        /// Thrown when the specified key does not exist in the collection.</exception>"
        public IEnumerable<TValue> Get(TKey key);

        /// <summary>
        /// Retrieves the collection of values associated with the specified key,
        /// or an empty collection if the key does not exist.
        /// </summary>
        /// <param name="key">The key whose associated values are to be returned. Cannot be null.</param>
        /// <returns>An enumerable collection of values associated with the specified key.
        /// If the key is not found, returns an empty collection.</returns>
        ...
        /// </summary>
        /// <remarks>The returned sequence includes all key-value pairs, regardless of their original
        /// nesting or structure within the collection. The order of the pairs in the sequence may depend on the
        /// underlying collection implementation.</remarks>
        /// <returns>An enumerable collection of <see cref="KeyValuePair{TKey, TValue}"/>
        /// representing all key-value pairs contained in the collection.</returns>
